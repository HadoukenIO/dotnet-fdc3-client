namespace OpenFin.FDC3.Constants
{
    internal static class ApiFromClientTopic
    {
        ...
        internal const string AddContextListener           = "ADD-CONTEXT-LISTENER";
        internal const string RemoveContextListener        = "REMOVE-CONTEXT-LISTENER";
        ...
        internal const string ChannelRemoveEventListener   = "CHANNEL-REMOVE-EVENT-LISTENER";
    }
}